...
struct path final {
	...
	static bool          is_same(const std::wstring& path, const wchar_t* other);
	static bool          is_same(const std::wstring& path, const std::wstring& other) { return is_same(path, other.c_str()); }
