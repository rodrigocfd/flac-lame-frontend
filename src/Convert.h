...
public:
	static bool pathsAreValid(const FileIni& ini, std::wstring *pErr = nullptr);

	static bool toWav(const FileIni& ini, std::wstring src, std::wstring dest, bool delSrc,
		std::wstring *pErr = nullptr);
	
	static bool toFlac(const FileIni& ini, std::wstring src, std::wstring dest, bool delSrc,
		const std::wstring& quality, std::wstring *pErr = nullptr);
	
	static bool toMp3(const FileIni& ini, std::wstring src, std::wstring dest, bool delSrc,
