...
namespace ctrl {
	...
	public:
		Resizer& add(std::initializer_list<int> ctrlIds, Window *parent, Do modeHorz, Do modeVert);
		Resizer& add(std::initializer_list<Window> children, Do modeHorz, Do modeVert);
	...
	public:
		...
		TextBox& create(Window *parent, int id, POINT pos, int cx, UINT extraStyles=0);
	...
	public:
		...
		Combo& create(Window *parent, int id, POINT pos, int cx);
	...
	public:
		...
		ListBox& create(Window *parent, int id, POINT pos, SIZE size);
	...
	public:
		...
		Radio& create(Window *parent, int id, const wchar_t *caption, bool beginGroup, POINT pos, SIZE size);
	...
	public:
		...
		CheckBox& create(Window *parent, int id, const wchar_t *caption, POINT pos, SIZE size);
	};
	...
	public:
		...
		ProgressBar& create(Window *parent, int id, POINT pos, SIZE size);
	...
	public:
		...
		ListView& create(Window *parent, int id, POINT pos, SIZE size);
