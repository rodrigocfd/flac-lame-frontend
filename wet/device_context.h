...
public:
	...
	public:
		...
		HPEN hpen() const { return this->_hPen; }
	...
	public:
		...
		HBRUSH hbrush() const { return this->_hBrush; }
...
public:
	...
	explicit device_context(const base_wnd* owner, HDC hDC = nullptr) :
		device_context(owner->hwnd(), hDC) { }
...
public:
	...
	explicit device_context_simple(const base_wnd* owner) :
		device_context_simple(owner->hwnd()) { }
};
...
public:
	...
	explicit device_context_buffered(const base_wnd* owner) :
		device_context_buffered(owner->hwnd()) { }
};
